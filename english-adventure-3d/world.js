...
import {terrainHeight,floorHeight,WORDS} from './state.js?v=4';
...
export function createWorld(scene,{low=false}={}){
 ...
 sign(2,32,'VALLEY TRAIL ↑');sign(4,-12,'CAFE →');sign(2,-49,'SUMMIT VIEW');
